...
* `min_adjustment_magnitude` - (Optional) The minimum absolute number capacity change when using "PercentChangeInCapacity" adjustment type. Without a value, AWS will default to 1.
